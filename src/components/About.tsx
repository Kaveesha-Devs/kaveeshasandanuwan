        ...
        <div className="grid items-center gap-16 lg:grid-cols-2">
          ...
          <div>
            ...
            <motion.h2
              ...
              className="mb-4 text-4xl font-bold leading-tight lg:text-5xl text-white/80"
            ...
            <motion.p
              ...
              className="mb-4 text-base leading-relaxed text-white/60"
            >
              Motivated and detail-oriented Software Engineering undergraduate
              at CINEC Campus. Proficient in front-end and back-end technologies
              including React, Next.js, Flutter, PHP, Java, and Python.
            </motion.p>
            ...
            <motion.p
              ...
              className="mb-10 text-base leading-relaxed text-white/60"
            >
              Experienced in software testing using Selenium WebDriver and
              JMeter, with expertise in UI/UX design using Figma. Currently
              enhancing skills through Machine Learning. Let's work together to
          ...
          >
            <div className="relative">
              {/* Soft glow */}
              <div className="absolute bottom-0 w-64 h-32 -translate-x-1/2 rounded-full left-1/2 bg-purple-500/20 blur-3xl" />

              {/* Photo — no frame */}
              <img
                src="/my22.png"
                alt="Kaveesha Sandanuwan"
                className="relative w-200 h-[850px] object-cover object-top"
                style={{
                  maskImage:
