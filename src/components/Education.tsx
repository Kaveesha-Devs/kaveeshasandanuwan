...
export default function Education() {
  ...
  return (
    <section id="education" ref={ref} className="relative py-32 overflow-hidden" style={{ background: '#050A12' }}>
      ...
      <div className="relative z-10 max-w-6xl px-6 mx-auto">
        ...
        <div className="relative">
          ...
          <div className="hidden lg:block absolute left-1/2 -translate-x-1/2 top-0 bottom-0 w-[3.5px] bg-gradient-to-b from-primary/60 via-primary/20 to-transparent" style={{ boxShadow: '0 0 12px rgba(10,255,163,0.3)' }} />
