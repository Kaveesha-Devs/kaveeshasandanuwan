          ...
          >
            <div className="relative">
              ...
              {[
                ...
                <motion.div
                  key={badge.label}
                  className="hidden lg:block absolute z-20 glass-card px-3 py-1.5 rounded-full text-xs font-mono text-primary border border-primary/20"
              ...
              {/* Photo — fully responsive */}
              <div className="relative w-64 h-80 sm:w-80 sm:h-[420px] lg:w-[420px] lg:h-[600px] xl:w-[480px] xl:h-[680px]">
                <img
                  src="/my11.png"
                ...
                <div className="absolute inset-0 items-center justify-center" style={{ display: 'none' }}>
                  <div className="text-center">
                    <div className="text-white font-display font-800 text-9xl">K</div>
                    <div className="-mt-6 font-display font-800 text-9xl text-primary">M</div>
                  </div>
                </div>
              </div>
            </div>
